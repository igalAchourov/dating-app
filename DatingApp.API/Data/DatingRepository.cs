...
namespace DatingApp.API.Data
{
    public class DatingRepository : IDatingRepository
    {
        ...
        //method for the GetUser method to return a list of int`s that we can then use 
        //to query against our users table in our db and will only returns user that
        //contains either the LikerId or the LikeeId that we wanna return. 
